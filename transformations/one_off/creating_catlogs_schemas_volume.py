...
spark.sql(" create catalog if not exists nyctaxi managed location 'abfss://unity-catalog-storage@dbstorageob4233bl2d2jm.dfs.core.windows.net/2336676087655059'")
